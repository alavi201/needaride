...
<body>
	<div id="header">
		...
		<h2 class="blockhead">Reply to <?php $response = mysql_query("select name from user where id = {$to}",$connection) or die(mysql_error()); $row=mysql_fetch_array($response) ;echo $row['name']; ?> </h2>
	<div class="block">
