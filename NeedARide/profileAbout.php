...
<body>
	<div id="container">
		<div id="header">
			...
			<div class="navigation" style="height: 68px">
				<ul style="position:relative; left: 2px; top: -26px; width: 500px;">
					...
					<li style="float:right" ><a href="index.html"><span>Logout</span></a></li>
				</ul>
		...
		<div id="profile1" style="width: 230px;position:relative; float:left; top: 10px; margin-left:15%;">
			<a href="#"><img height="125" src="img/profile.jpg" width="200" /></a>
		</div>
		
		<div id= "profile-info" style="float:right;margin-right: 200px; margin-top:-90px;">
		<?php 
...
{	
	echo "<form id='info' method='post' action='update.php' style='width: 320px'>
				<input name='name' type='text' readonly value='".$row['Name']."'><br>
				<input name='gender' type='text' readonly value='".$row['gender']."'><br>
				<input name='dob' type='date' readonly value='".$row['dob']."'><br><br>
				<input type='submit' value='Back' style='margin-left: 180px;'>
			</form> ";
}	
?>
		</div>
