...
<body style="font-size: 20px;">
	<div id="container">
		...
		<div id="content">
			...
			<?php			$response = mysql_query("SELECT * from ride where creator = {$id} order by ride_id desc",$connection) or die(mysql_error());
$count = 1;
...
$response = mysql_query("Select Name from user where Id in(SELECT user2 from friend_of where user1 = {$id} and accepted = 1)",$connection) or die(mysql_error());
